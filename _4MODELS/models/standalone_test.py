...
try:
    pos_enc_module = load_module_from_file(
        'position_encoding',
        f'{project_root}/_4MODELS/block/position_encoding.py'
    )
...
try:
    lattice_utils = load_module_from_file(
        'lattice_utils',
        f'{project_root}/_4MODELS/block/lattice_utils.py'
    )
...
try:
    ...
    # 创建一个虚拟的 block 包
    block_module = types.ModuleType('_4MODELS.block')
    ...
    sys.modules['_4MODELS.block'] = block_module
    sys.modules['_4MODELS.block.position_encoding'] = pos_enc_module
    sys.modules['_4MODELS.block.lattice_utils'] = lattice_utils
    
    lattice_attn = load_module_from_file(
        'lattice_attention',
        f'{project_root}/_4MODELS/block/lattice_attention.py'
    )
