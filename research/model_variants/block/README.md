...
```python
from research.model_variants.block import SinusoidalPositionEncoding
...
```python
from research.model_variants.block import RelativePositionEncoding
...
```python
from research.model_variants.block import FourPositionFusion
...
```python
from research.model_variants.block import MultiInputLSTMCell
...
```python
from research.model_variants.block import LatticeLSTMEncoder
...
```python
from research.model_variants.block import MultiHeadAttentionWithRelativePosition
...
```python
from research.model_variants.block import LatticeSelfAttention
...
```python
from research.model_variants.block import TransformerEncoderLayer
...
```python
from research.model_variants.block import AdaptiveDropout
...
```python
from research.model_variants.block import LayerProcess
...
```python
from research.model_variants.block import PositionwiseFeedForward
...
```python
from research.model_variants.block import AbsolutePositionEmbedding
...
```python
from research.model_variants.block import StartEndPositionEmbedding
