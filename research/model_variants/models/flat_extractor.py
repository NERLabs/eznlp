...
参考: references/external_projects/Flat-Lattice-Transformer-master/V1/models.py
...
# 导入已实现的组件
try:
    from research.model_variants.block.position_encoding import FourPositionFusion
    from research.model_variants.block.lattice_attention import LatticeSelfAttention, TransformerEncoderLayer
    from research.model_variants.block.lattice_utils import LayerProcess, PositionwiseFeedForward
except ImportError:
