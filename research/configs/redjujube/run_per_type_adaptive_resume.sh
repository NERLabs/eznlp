...
LOG_FILE="logs/research_logs/per_type_adaptive_resume.log"
...
# Data paths
BOSON_TRAIN="datasets/raw/boson/boson.train.bmes"
BOSON_DEV="datasets/raw/boson/boson.dev.bmes"
BOSON_TEST="datasets/raw/boson/boson.test.bmes"

CLUE_TRAIN="datasets/raw/clue/train.char.bmes"
CLUE_DEV="datasets/raw/clue/dev.char.bmes"
CLUE_TEST="datasets/raw/clue/test.char.bmes"
