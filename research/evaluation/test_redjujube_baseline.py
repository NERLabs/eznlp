...
- 可选：导出预测结果文件，配合 research.evaluation/view_predictions.py 做人工检查
"""
...
# 添加项目根目录到 sys.path，才能导入 research.training.*
...
from research.training.redjujube_data_loader import RedJujubeDataLoader, DataPreparationPipeline
...
def evaluate_and_analyze(save_dir, model_type="baseline", export_predictions=True, expert_dict_auto_path_override=None):
    ...
    if model_type == "baseline":
        ...
        if "auto" in model_type:
            ...
            expert_dict_path = args.get(
                "expert_dict_path",
                "datasets/raw/RedJujube/expert_lexicon.txt",
            )
    ...
    if export_predictions:
        ...
        print("可以用以下命令查看错误样本：")
        print(
            f"  python research.evaluation/view_predictions.py "
