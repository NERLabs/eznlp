...
run_crf_baseline() {
    ...
    conda run -n ${CONDA_ENV} python research/training/train_redjujube_ner.py \
        --data_dir ${data_dir} \
        --bert_arch ${BERT_ARCH} \
        --save_dir ${save_dir} \
        --seed ${seed} \
...
run_bs_dict() {
    ...
    conda run -n ${CONDA_ENV} python research/training/train_general_expert_boundary.py \
...
for seed in "${SEEDS[@]}"; do
    run_crf_baseline "msra" "datasets/raw/msra_as_redjujube" ${seed}
done

# BS+Dict x 3 seeds
for seed in "${SEEDS[@]}"; do
    run_bs_dict "msra" "datasets/raw/msra_as_redjujube" ${seed}
done
...
# CRF基线 x 3 seeds
for seed in "${SEEDS[@]}"; do
    run_crf_baseline "resume" "datasets/raw/resume_as_redjujube" ${seed}
done

# BS+Dict x 3 seeds
for seed in "${SEEDS[@]}"; do
    run_bs_dict "resume" "datasets/raw/resume_as_redjujube" ${seed}
done
...
# CRF基线 x 3 seeds
for seed in "${SEEDS[@]}"; do
    run_crf_baseline "weibo" "datasets/raw/weibo_as_redjujube" ${seed}
done

# BS+Dict x 3 seeds
for seed in "${SEEDS[@]}"; do
    run_bs_dict "weibo" "datasets/raw/weibo_as_redjujube" ${seed}
done
...
# CRF基线 x 3 seeds
for seed in "${SEEDS[@]}"; do
    run_crf_baseline "peopledaily" "datasets/raw/peopledaily_as_redjujube" ${seed}
done

# BS+Dict x 3 seeds
for seed in "${SEEDS[@]}"; do
    run_bs_dict "peopledaily" "datasets/raw/peopledaily_as_redjujube" ${seed}
done
...
for seed in "${SEEDS[@]}"; do
    run_crf_baseline "pingguo" "datasets/raw/pingguo_as_redjujube" ${seed}
done
