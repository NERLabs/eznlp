...
| 12-2周 | [12-2_softlexicon.md](./12-2_softlexicon.md) | 2025-12-09~13 | 🔄 进行中 | SoftLexicon + 训练集词表 |
| 12-3周 | [12-3_soft_expert_joint.md](./12-3_soft_expert_joint.md) | 待定 | ⏳ 计划中 | Soft+Expert 联合 |
...
**当前进度**:
- ✅ 任务1: 环境确认
- ✅ 任务2: 复现 Baseline vs ExpertDict
- ✅ 任务3: SoftLexicon (CTB词表) - **F1: 95.88%**
- 🔄 任务4: SoftLexicon (训练集词表) - **训练中**

**当前状态** (2025-12-10):
- SoftLexicon-TrainLex 训练进行中
- 已完成 Epoch 10/30
- 当前验证集 F1: 97.8%+
- 预计完成时间: 今日内

**详细计划**:
- [12-2_softlexicon.md](./12-2_softlexicon.md) (待创建)
- [hz_lexicon_2weeks.md - 12-2周](./hz_lexicon_2weeks.md#第-1-周跑通--对齐基线--软词典策略)
...
**计划任务**:
1. Soft vs Expert 详细对比
2. 实现 SoftLexicon + ExpertDict 联合模型
3. 探索混合词典方案
4. 撰写阶段总结报告

**详细计划**:
- [12-3_soft_expert_joint.md](./12-3_soft_expert_joint.md) (待创建)
...
| 方法 | HZ 数据集 | MSRA 数据集 | 词表来源 | 状态 |
|------|----------|------------|---------|------|
| Baseline | 95.618% | 95.092% | - | ✅ |
| +ExpertDict(手工) | **97.941%** | 95.424% | 手工标注 | ✅ |
| +ExpertDict(自动) | **97.050%** | - | 训练集提取 | ✅ |
| SoftLexicon(CTB) | **95.88%** | - | CTB 50d | ✅ |
| SoftLexicon(TrainLex) | 🔄 训练中 | - | 训练集n-gram | 🔄 |
| Soft+Expert | ⏳ 计划中 | - | 混合 | ⏳ |
...
- **模型缓存**: `/cache/hz_softlexicon/`, `/cache/hz_ner_comparison/`
