...
```json
{
  ...
  "script": "python _1CONFIG/redjujube/train_redjujube_ner_comparison.py",
  "data_dir": "_2DATA/RedJujube",
  "softlex_train_path": "_2DATA/RedJujube/softlexicon_train.txt",
...
python _7PIPELINE/experiment_pipeline.py \
  ...
  --config _7PIPELINE/config_templates/softlexicon_example.json &

# ExpertDict
python _7PIPELINE/experiment_pipeline.py \
  --name "RedJujube_ExpertDict" \
  --config _7PIPELINE/config_templates/expert_dict_example.json &
...
- [监控系统文档](../_8TOOL/monitoring/MONITORING_TOOLS.md)
- [邮件通知系统](../_4MONITORING/README.md)
- [结果收集脚本](../_6EVALUATE/format_redjujube_results.py)
