...
# 定义要运行的实验
experiments=(
    "RedJujube_Baseline|_7PIPELINE/config_templates/baseline_example.json"
    "RedJujube_SoftLexicon|_7PIPELINE/config_templates/softlexicon_example.json"
    "RedJujube_ExpertDict|_7PIPELINE/config_templates/expert_dict_example.json"
)
...
for exp in "${experiments[@]}"; do
    ...
    # 构建命令
    cmd="python _7PIPELINE/experiment_pipeline.py \
        --name \"$name\" \
        --config \"$config\" \
        --skip-test \
