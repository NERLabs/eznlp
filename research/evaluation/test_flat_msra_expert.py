...
from research.model_variants.models.flat_data_processor import FLATDataProcessor, load_word_list
from research.model_variants.models.flat_extractor import FLATModel  # 仅为类型提示，实际直接 load
from research.training.train_flat_complete import extract_entities  # 复用 BMES 实体抽取逻辑
