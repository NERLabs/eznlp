...
DICT_PATH="datasets/raw/RedJujube/expert_lexicon_auto_min1.txt"
...
for SEED in "${SEEDS[@]}"; do
    echo "[G] 运行 seed=$SEED ..."
    python research/training/train_redjujube_bilstm_crf.py \
        --data_dir "$DATA_DIR" \
...
echo ""
echo "运行结果收集脚本:"
echo "  python research/evaluation/collect_optimization_results.py"
echo "============================================================"
