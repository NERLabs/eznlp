...
def main():
    ...
    # 数据参数
    parser.add_argument('--data_dir', type=str, default='_2DATA/MSRA',
                        help='数据目录')
    parser.add_argument('--expert_dict_path', type=str, default='_2DATA/MSRA/expert_lexicon_auto.txt',
                        help='手动专家词典路径')
    parser.add_argument('--expert_dict_auto_path', type=str, default='_2DATA/MSRA/expert_lexicon_auto.txt',
                        help='自动专家词典路径')
    ...
    parser.add_argument('--softlex_train_path', type=str, default='_2DATA/MSRA/softlexicon_train.txt',
