...
def test_config_templates():
    ...
    templates_dir = Path("research/pipelines/config_templates")
...
def test_scripts():
    ...
    scripts = [
        "research/pipelines/experiment_pipeline.py",
        "research/pipelines/run_pipeline.sh",
        "research/pipelines/run_all_pipelines.sh"
    ]
...
def test_pipeline_import():
    ...
    try:
        # 不使用相对导入，直接读取文件
        pipeline_file = Path("research/pipelines/experiment_pipeline.py")
...
def test_directories():
    ...
    dirs = [
        "research/pipelines",
        "research/pipelines/config_templates",
...
def main():
    ...
    if passed == total:
        ...
        print("  或")
        print("  bash research/pipelines/run_pipeline.sh --baseline --name \"测试实验\"")
        print("")
        return 0
    else:
